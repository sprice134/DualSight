...
'''NOTE TO SELF:
When there are detected particles that one of them contains a majority of the other one, 
say, 90% of one particle is contained within another one, delete the small one'''
